...
async def test_17bit_transmission(dut):
    ...
    dut._log.info("Starting transmission")
    ...
    assert received_data == expected_data, f"Complete data mismatch. Expected 0x{expected_data:05X}, got 0x{received_data:05X}"

    dut._log.info("Test completed successfully")

def uart_wrapper_runner():
    """Simulate the UART wrapper using the Python runner."""
